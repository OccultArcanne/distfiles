...
cd ~ &&
git clone https://github.com/OccultArcanne/st.git ~/usr/local/Suckless/st &&
git clone https://github.com/OccultArcanne/void-packages.git ~/usr/local/void-packages &&
...
git clone https://github.com/OccultArcanne/chadwm.git --depth 1  ~/.config/chadwm &&
